-- Evita que dos altas simultaneas del mismo correo intenten crear dos
-- identidades globales. El conflicto espera la otra transaccion y reutiliza la
-- cuenta que termine ganando.
...
begin
  ...
  on conflict (correo) where eliminado_en is null do nothing
