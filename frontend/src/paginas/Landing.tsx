...
export function Landing() {
  return (
    <main>
      ...
      <section className="border-b border-regla bg-white" data-reveal>
        <div className="mx-auto max-w-[1200px] px-5 py-20 sm:px-8 lg:py-24">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <p className="max-w-xl self-end text-base leading-8 text-tinta-media lg:justify-self-end">Educa organiza cada momento del proceso académico para que las personas encuentren lo que necesitan sin perder tiempo navegando sistemas distintos.</p>
          </div>
      ...
      <LlamadaFinal titulo="Tu comunidad merece una plataforma más clara." texto="Empieza a organizar la experiencia académica de tu institución con Educa." />
    </main>
  )
}
...
function VistaProducto() {
  return (
    <div className="hero-producto relative" aria-label="Vista previa de la plataforma Educa">
      ...
      <div className="relative border border-[#afbbb2] bg-white shadow-[10px_10px_0_#c8d4cb]">
        <div className="flex h-12 items-center border-b border-regla bg-[#12302a] px-4 text-white"><BookOpen size={17} /><span className="ml-2 text-sm font-semibold">Educa</span><span className="ml-auto font-dato text-[9px] uppercase tracking-widest text-white/45">Inicio</span></div>
