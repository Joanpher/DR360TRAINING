...
export function ProductoPublico() {
  ...
  return <main>
    <Cabecera etiqueta="Producto" titulo="Una plataforma que organiza el trabajo académico." texto="Educa conecta las tareas cotidianas de una institución en una experiencia consistente, rápida y fácil de aprender." />
...
export function SeguridadPublica() {
  ...
  return <main>
    <Cabecera etiqueta="Seguridad" titulo="La confianza no es una función adicional." texto="La separación de datos y el control de acceso forman parte de la arquitectura de Educa desde el primer día." />
    ...
    <LlamadaFinal titulo="Protege la operación sin complicar el trabajo." texto="Conoce cómo Educa mantiene separados los datos y claras las responsabilidades." />
  </main>
}

export function NosotrosPublico() {
  return <main>
    <Cabecera etiqueta="Nosotros" titulo="Tecnología educativa con criterio y cercanía." texto="Creamos Educa para reducir la distancia entre lo que una institución necesita hacer y lo que su software le permite hacer." />
    ...
    <LlamadaFinal titulo="Construyamos una experiencia académica más humana." texto="Educa está lista para acompañar la siguiente etapa de tu institución." />
  </main>
}
